 ...
 */
final class Version20250220153103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE storage_file (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(255) NOT NULL, hash VARCHAR(255) NOT NULL, uid VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE storage_file');
